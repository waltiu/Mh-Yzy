  ...
  <div>
    ...
    >
      <div v-loading="loading">
        <el-tabs value="info">
          <el-tab-pane :label="$t('main.basicInformation')" name="info" @click="getAddress">
            <edit-add-info
...
export default {
  ...
  methods: {
    ...
    getAddress () {
      return 'http://api.map.baidu.com/geocoder/v2/?callback=renderReverse&location=' + this.fullData.lat + ',' + this.fullData.lng + '&output=json&pois=1&ak=gTFWcx9MY4m9HVGVZGijrXPYgnKkbpep'
    },
    submit () {
