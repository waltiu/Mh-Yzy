<template>
  <!-- 用来CURD多个项目 - 侧栏 -->
  <div>
    <el-card class="box-card unselectable" style="padding:  0px; margin-top: 10px;margin-left: 15px">
      <el-alert :title="$t('cable.prompt')" :description="$t('cable.description')" type="warning" :closable="false">
      </el-alert>

      <SlickList lockAxis="y" v-model="list" :useDragHandle="true">
        <SlickItem v-for="(item, index) in list" :index="index" :key="index" style="z-index: 3000">

          <!-- Index 即为当前的索引 -->
          <el-card class="box-card" style="margin-top: 10px;" shadow="never">

            <div>
              <!-- <el-tooltip content="删除当前管道段" placement="left"> -->
            ...
            <div v-loading="item.loading">
              ...
              <div style="margin-top: 10px;">
                ...
                <div style="margin-top: 15px; margin-bottom: 15px; margin-left: 10px; display: flex;">

                  <i v-handle class="el-icon-menu" style="margin-right: 5px; font-size: 18px;"></i>

                  <el-badge :value="!_.isEmpty(del[index]) || item.id  ? '' : $t('cable.newPipeSection')" class="item">
                    {{ item.name }}
                  </el-badge>
                ...
                <div style="margin-left: 50px; display: flex;">
                  <div style="border: 1px solid #808080;width: 1px;height: 40px;">
                  </div>
                ...
                <div style="float: right; margin-top: 10px;margin-bottom: 10px;">
                  <el-tooltip :content="$t('cable.editPipeName')" placement="left">
                    <el-button @click="editSectionName(index, item)" icon="el-icon-edit" size="mini" type="primary" style="margin-left: 20px;" circle></el-button>
                  </el-tooltip>
                  <el-tooltip :content="$t('cable.exchange')" placement="left">
                    <el-button @click="reverse(index, item)" icon="el-icon-sort" size="mini" type="primary" style="margin-left: 5px;" circle></el-button>
                  </el-tooltip>
                </div>
