  ...
  >
    <div v-loading="loading">
      <el-tabs value="baseInfo">
        <el-tab-pane :label="$t('well.rodInformation')" name="baseInfo">
        ...
        <el-tab-pane :label="$t('well.affiliatedRoad')" name="relatedPipe">
          <table-and-paging
            :colums="returnColums('pipe')"
            :tableData="fullData.ldsysLine ? [fullData.ldsysLine] : []"
          ></table-and-paging>
        </el-tab-pane>
      </el-tabs>
    </div>
