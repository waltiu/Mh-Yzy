<template>
  ...
  >
    <el-form label-position="left" label-width="90">
      ...
      <div>
        <el-form-item v-show="infos.jumpType === 'inner'" label>
          <in-device
            :fullData="fullData"
            :info="infos"
            :editInfo="selectInfo"
        ...
        <el-form-item v-show="infos.jumpType === 'room'" label>
          <in-room :fullData="fullData" :info="infos" :editInfo="selectInfo" @returnData="bindData"></in-room>
        </el-form-item>
      </div>
    </el-form>
